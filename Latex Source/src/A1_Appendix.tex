...
\begin{figure}[th]
	...
	\end{subfigure}
	\caption[Overview of the system's performance with congestion limits and less charging time]{Overview of the system's performance with congestion limits and less charging time.
...
\begin{figure}[th]
	...
	\end{subfigure}
	\caption[Overview of system's performance with congestion limits and less charging time]{Overview of system's performance with congestion limits and less charging time.
		\subfigref{app:fig:nyc_road_usage_simu2} illustrates the utilization of the entire road network during the whole shift, while \subfigref{app:fig:charge_vehicle_baseline_cong_simu2} shows averaging charging percentage of the vehicles. 
	}
...
\end{figure}
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{State of charge of an exemplary set of vehicles for Sim. 5}
...
\begin{figure}[th]
	...
	\caption[State of charge of an exemplary set of vehicles for Sim. 3 and 4]{ State of charge of an exemplary set of vehicles for Sim. 3 and 4. \subfigref{fig:ex_soc_vehicles} is the SOC of simulation three, while  \subfigref{fig:ex_soc_vehicles2} represents run number four.}
	\label{fig:ex_soc}
\end{figure}
